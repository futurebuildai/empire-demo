...
import './pages/page-estimate-details.js';
...
import './pages/page-document-center.js';
...
export function initRouter(outlet: HTMLElement): Router {
    ...
    router.setRoutes([
        ...
        { path: '/admin/estimates/:id', component: 'admin-page-estimate-details' },
        ...
        { path: '/admin/documents', component: 'admin-page-document-center' },
        { path: '(.*)', redirect: '/admin' },
    ]);
