...
export class AdminLayout extends LitElement {
    ...
    @state() private branding: any = null;
    ...
    connectedCallback() {
        ...
        BrandingService.subscribe((branding) => {
            this.branding = branding;
        });
    }
    ...
    render() {
        ...
        return html`
            <nav>
                <div class="logo-area">
                    <div class="logo-icon">
                        ${this.branding?.logoUrl ? html`<img src="${this.branding.logoUrl}" alt="Logo">` : html`V`}
                    </div>
                </div>
                <div class="nav-links">
                    ...
                    <a href="/admin/documents" class="${isActive('/admin/documents') ? 'active' : ''}">
