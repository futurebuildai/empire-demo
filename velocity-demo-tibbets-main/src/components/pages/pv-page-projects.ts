        ...
        <div class="projects-grid">
          ${this.filteredProjects.map(project => html`
            <div class="project-card">
              ...
              <button class="btn btn-outline btn-sm" @click=${() => RouterService.navigate('orders', { jobId: project.id })}>Orders</button>
              <button class="btn btn-outline btn-sm" @click=${() => RouterService.navigate('estimates', { jobId: project.id })}>Estimates</button>
              <button class="btn btn-outline btn-sm" @click=${() => RouterService.navigate('billing', { jobId: project.id })}>Invoices</button>
            </div>
            </div>
          `)}
        </div>
